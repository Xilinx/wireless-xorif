...
#define RD_REG(i, a) xocp_read_reg_internal(DEV(i), #a, ADDR(a), MASK(a), SHIFT(a), WIDTH(a))
#define WR_REG(i, a, v) xocp_write_reg_internal(DEV(i), #a, ADDR(a), MASK(a), SHIFT(a), WIDTH(a), v)
#define RD_REG_OFFSET(i, a, o) xocp_read_reg_internal(DEV(i), #a, ADDR(a) + (o), MASK(a), SHIFT(a), WIDTH(a))
#define WR_REG_OFFSET(i, a, o, v) xocp_write_reg_internal(DEV(i), #a, ADDR(a) + (o), MASK(a), SHIFT(a), WIDTH(a), v)

// Macros to read/write whole register
#define RD_REG_ALT(i, a) xocp_read_reg_internal(DEV(i), #a, ADDR(a), 0xFFFFFFFF, 0, 32)
#define WR_REG_ALT(i, a, v) xocp_write_reg_internal(DEV(i), #a, ADDR(a), 0xFFFFFFFF, 0, 32, v)
#define RD_REG_OFFSET_ALT(i, a, o) xocp_read_reg_internal(DEV(i), #a, ADDR(a) + (o), 0xFFFFFFFF, 0, 32)
#define WR_REG_OFFSET_ALT(i, a, o, v) xocp_write_reg_internal(DEV(i), #a, ADDR(a) + (o), 0xFFFFFFFF, 0, 32, v)
