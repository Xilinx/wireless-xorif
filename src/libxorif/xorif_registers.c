...
static const reg_info_t reg_map[] = {
    ...
    {"CFG_CONFIG_XRAN_COMP_32BIT_MODE_ENABLED", 0x28, 0x100, 8, 1}, // NEW
    ...
    {"CFG_CONFIG_XRAN_FRAM_SECTION", 0x60, 0xff, 0, 8},
    ...
    {"CFG_CONFIG_XRAN_MAX_DL_SYMBOLS", 0x30, 0x7f, 0, 7},
    ...
    {"CFG_FRAM_INT_ENA_SECTION_OF", 0x14, 0x10000, 16, 1},
    ...
    {"CFG_FRAM_INT_SECTION_OF", 0x18, 0x10000, 16, 1},
    ...
    {"DEFM_CID_MAP_RD_STREAM_CCID", 0x6908, 0xf000000, 24, 4},
    ...
    {"DEFM_CID_MAP_WR_STREAM_CCID", 0x6904, 0xf000000, 24, 4},
    ...
    {"FRAM_STALL_MONITOR_DL_SS_19_8", 0x2308, 0xfff00, 8, 12},
    {"FRAM_STALL_MONITOR_DL_SS_7_0", 0x2304, 0xff0000, 16, 8},
    {"FRAM_STALL_MONITOR_SSB_3_0", 0x2304, 0xf000000, 24, 4},
    {"FRAM_STALL_MONITOR_UL_PRACH_3_0", 0x2304, 0xf00, 8, 4},
    {"FRAM_STALL_MONITOR_UL_SS_15_8", 0x2308, 0xff, 0, 8},
    {"FRAM_STALL_MONITOR_UL_SS_7_0", 0x2304, 0xff, 0, 8},
    {"FRAM_STALL_MONITOR_UL_UNSOL_3_0", 0x2304, 0xf000, 12, 4},
    {"FRAM_STALL_SAMPLE", 0x2300, 0x1, 0, 1},
