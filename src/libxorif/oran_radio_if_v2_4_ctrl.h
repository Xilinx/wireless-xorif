...
*------------------------------------------------------------------------------
*/
#define ORAN_RADIO_IF_V2_4_CFG_BASE_ADDR 0x0 /* 0 */
#define ORAN_RADIO_IF_V2_4_FRAM_BASE_ADDR 0x2000 /* 8192 */
#define ORAN_RADIO_IF_V2_4_DEFM_BASE_ADDR 0x6000 /* 24576 */
#define ORAN_RADIO_IF_V2_4_ETH_BASE_ADDR 0xa000 /* 40960 */
#define ORAN_RADIO_IF_V2_4_STATS_BASE_ADDR 0xc000 /* 49152 */
#define ORAN_RADIO_IF_V2_4_ORAN_BASE_ADDR 0xe000 /* 57344 */
#define ORAN_RADIO_IF_V2_4_CHAN_PROC_CFG_BASE_ADDR 0x10000 /* 65536 */
#define ORAN_RADIO_IF_V2_4_CHAN_PROC_FRAM_BASE_ADDR 0x12000 /* 73728 */
#define ORAN_RADIO_IF_V2_4_CHAN_PROC_SETUP_BASE_ADDR 0x14000 /* 81920 */
#define ORAN_RADIO_IF_V2_4_CHAN_PROC_SEQUENCE_TABLE_BASE_ADDR 0x16000 /* 90112 */

/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_cfg 
...
#define CFG_VERSION_REVISION_DEFAULT 0x2 /* 2 */
...
#define CFG_INTERNAL_REVISION_DEFAULT 0x15f1cd2 /* 23010514 */
...
/* Type   = rw  */
/* sigena =  */
/* Doc    : NODOC Flag used to sample status register in alternate clock domains. */
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_fram 
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_defm 
...
/* Type   = rw  */
/* sigena =  */
/* Doc    : Set the full table mapping model. 1={Direction,RU_Port_ID} (Default), 3={Direction,Band Sector,RU_Port_ID}  */
...
/* Type   = rw  */
/* sigena =  */
/* Doc    : NODOC Set the internal stream CC ID. */
...
/* Type   = roSig  */
/* sigena =  */
/* Doc    : NODOC Read the internal stream CC ID. */
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_eth 
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_stats 
...
/* Type   = roSig  repeats using C_ETH_W @ multiples of 0x100 */
/* sigena =  */
/* Doc    : O-RAN (either U- or C-Plane) on_time received packets (LSB) */
...
/* Type   = roSig  repeats using C_ETH_W @ multiples of 0x100 */
/* sigena =  */
/* Doc    : O-RAN (either U- or C-Plane) on_time received packets (HSB) */
...
/* Type   = roSig  repeats using C_ETH_W @ multiples of 0x100 */
/* sigena =  */
/* Doc    : O-RAN (either U- or C-Plane) received packets arrived before the start of time window (LSB) */
...
/* Type   = roSig  repeats using C_ETH_W @ multiples of 0x100 */
/* sigena =  */
/* Doc    : O-RAN (either U- or C-Plane) received packets arrived before the start of time window (HSB) */
...
/* Type   = roSig  repeats using C_ETH_W @ multiples of 0x100 */
/* sigena =  */
/* Doc    : O-RAN (either U- or C-Plane) received packets arrived after the end of time window (LSB) */
...
/* Type   = roSig  repeats using C_ETH_W @ multiples of 0x100 */
/* sigena =  */
/* Doc    : O-RAN (either U- or C-Plane) received packets arrived after the end of time window (HSB) */
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_oran 
...
/* Type   = rw  */
/* sigena =  */
/* Doc    : NODOC  Remove from Core. Simulation only, start cycle in symbol count for timer */
...
/* Type   = rw  */
/* sigena =  */
/* Doc    : NODOC  Remove from Core. Simulation only, Factory use */
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_chan_proc_cfg 
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_chan_proc_fram 
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_chan_proc_setup 
...
/* Type   = rwpdef  repeats using C_MAX_COMP_CARR @ multiples of 0x010 */
/* sigena =  */
...
/* Type   = roSig  repeats using C_MAX_COMP_CARR @ multiples of 0x010 */
/* sigena =  */
...
/*-----------------------------------------------------------------------------
* C Header bank register definitions for bank oran_radio_if_v2_4_chan_proc_sequence_table 
