...
XORIF> xorif_set_ru_ports_table(128, 0, 1, 16)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x80001080 (2147487872)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x80041081 (2147750017)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x80081082 (2148012162)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x800C1083 (2148274307)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x80101084 (2148536452)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x80141085 (2148798597)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x80181086 (2149060742)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x801C1087 (2149322887)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x80201088 (2149585032)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x80241089 (2149847177)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x8028108A (2150109322)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x802C108B (2150371467)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x8030108C (2150633612)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x8034108D (2150895757)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x8038108E (2151157902)
XORIF> WRITE_REG: DEFM_CID_MAP_WR_STROBE_ADDR (0x6904) <= 0x803C108F (2151420047)
...
The above programming would give rise to the following mapping table. Note, empty lines are not shown and should be unmapped. Use the xorif_set_ru_ports_table_mode() API call to clear the table prior to programming, or selectively remap modified addresses as required.

| RU port | Address | Type   | SS  |
|---------|---------|--------|-----|
| 0       | 0       | PUxCH  | 0   |
| 1       | 1       | PUxCH  | 1   |
| 2       | 2       | PUxCH  | 2   |
